...
const TOOL_TO_PHASE: Record<string, string> = {
  ...
  load_local_workspace: 'repo_analyzed',
  loadLocalWorkspace: 'repo_analyzed',
  load_remote_repository: 'repo_analyzed',
  loadRemoteRepository: 'repo_analyzed',
  update_application: 'app_updated',
  updateApplication: 'app_updated',
  quick_deploy: 'deploy_started',
  quickDeploy: 'deploy_started',
